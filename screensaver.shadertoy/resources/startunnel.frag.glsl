// from https://www.shadertoy.com/view/MdlXWr

#define PASS_COUNT 2

static float fBrightness = 2.5;

// Number of angular segments
static float fSteps = 121.0;

static float fParticleSize = 0.015;
...
static float fMinDist = 0.8;
static float fMaxDist = 5.0;

static float fRepeatMin = 1.0;
static float fRepeatMax = 2.0;

// fog density
static float fDepthFade = 0.8;
